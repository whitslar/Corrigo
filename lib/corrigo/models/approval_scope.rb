...
module Corrigo
  class ApprovalScope
    ...
    attr_accessor :approval_template
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Corrigo::ApprovalScope` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Corrigo::ApprovalScope`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'approval_template')
        self.approval_template = attributes[:'approval_template']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          approval_template == o.approval_template
    end
    ...
    def hash
      [id, perform_deletion, concurrency_id, actor_id, actor_type_id, is_default, approval_template].hash
    end
