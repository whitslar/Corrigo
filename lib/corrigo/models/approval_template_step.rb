  ...
  class ApprovalTemplateStep
    ...
    def self.openapi_types
      {
        ...
        :'actor_id' => :'Integer',
        :'rule_id' => :'ApprovalRule',
        :'auto_skip_hours' => :'Integer',
        :'is_parallel' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Corrigo::ApprovalTemplateStep` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Corrigo::ApprovalTemplateStep`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'approval_template_id')
        self.approval_template_id = attributes[:'approval_template_id']
      end
      ...
      if attributes.key?(:'auto_skip_hours')
        self.auto_skip_hours = attributes[:'auto_skip_hours']
      end

      if attributes.key?(:'is_parallel')
        self.is_parallel = attributes[:'is_parallel']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          approval_template_id == o.approval_template_id &&
          step_number == o.step_number &&
          actor_type_id == o.actor_type_id &&
          actor_id == o.actor_id &&
          rule_id == o.rule_id &&
          auto_skip_hours == o.auto_skip_hours &&
          is_parallel == o.is_parallel
    end
    ...
    def hash
      [id, perform_deletion, concurrency_id, approval_template_id, step_number, actor_type_id, actor_id, rule_id, auto_skip_hours, is_parallel].hash
    end
