...
module Corrigo
  class BusinessHours
    ...
    attr_accessor :day_idx_day_of_week
    ...
    def self.attribute_map
      {
        ...
        :'day_idx_day_of_week' => :'DayIdxDayOfWeek',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Corrigo::BusinessHours` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Corrigo::BusinessHours`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'day_idx_day_of_week')
        self.day_idx_day_of_week = attributes[:'day_idx_day_of_week']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          day_idx_day_of_week == o.day_idx_day_of_week &&
    ...
    def hash
      [id, perform_deletion, concurrency_id, actor_id, actor_type_id, day_idx_day_of_week, finish_time, start_time].hash
    end
