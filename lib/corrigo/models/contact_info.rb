...
module Corrigo
  class ContactInfo
    ...
    attr_accessor :addr_type_id

    attr_accessor :address

    attr_accessor :is_alert
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Corrigo::ContactInfo` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Corrigo::ContactInfo`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'addr_type_id')
        self.addr_type_id = attributes[:'addr_type_id']
      end
      ...
      if attributes.key?(:'is_alert')
        self.is_alert = attributes[:'is_alert']
      end

      if attributes.key?(:'is_report')
        self.is_report = attributes[:'is_report']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          actor_id == o.actor_id &&
          addr_type_id == o.addr_type_id &&
          address == o.address &&
          is_alert == o.is_alert &&
          is_report == o.is_report
    end
    ...
    def hash
      [id, perform_deletion, concurrency_id, actor_type_id, actor_id, addr_type_id, address, is_alert, is_report].hash
    end
