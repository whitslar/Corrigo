...
module Corrigo
  class InvoiceDictionaryItem
    ...
    attr_accessor :gl_expense

    attr_accessor :gl_income
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Corrigo::InvoiceDictionaryItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Corrigo::InvoiceDictionaryItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cost_category')
        self.cost_category = attributes[:'cost_category']
      end

      if attributes.key?(:'gl_expense')
        self.gl_expense = attributes[:'gl_expense']
      end

      if attributes.key?(:'gl_income')
        self.gl_income = attributes[:'gl_income']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          gl_expense == o.gl_expense &&
          gl_income == o.gl_income
    end
    ...
    def hash
      [id, perform_deletion, concurrency_id, is_removed, display_as, descr, tax_code, cost_category, gl_expense, gl_income].hash
    end
