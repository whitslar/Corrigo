...
module Corrigo
  class PaymentItem
    ...
    attr_accessor :amt_used

    attr_accessor :ref_invoice

    attr_accessor :ref_payment
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Corrigo::PaymentItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Corrigo::PaymentItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_credit')
        self.is_credit = attributes[:'is_credit']
      end
      ...
      if attributes.key?(:'amt_used')
        self.amt_used = attributes[:'amt_used']
      end

      if attributes.key?(:'ref_invoice')
        self.ref_invoice = attributes[:'ref_invoice']
      end

      if attributes.key?(:'ref_payment')
        self.ref_payment = attributes[:'ref_payment']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          amt_used == o.amt_used &&
          ref_invoice == o.ref_invoice &&
          ref_payment == o.ref_payment
    end
    ...
    def hash
      [id, perform_deletion, concurrency_id, currency_type_id, object_type_id, object_id, is_credit, amt_balance, amt_used, ref_invoice, ref_payment].hash
    end
