  ...
  class ProviderCoi
    ...
    def self.openapi_types
      {
        ...
        :'display_as' => :'String',
        :'employee_id' => :'Integer',
        :'amt_coverage' => :'MoneyValue',
        :'status_id' => :'InsuranceStatus',
        :'start_date' => :'Time',
        :'end_date' => :'Time',
        :'comment' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Corrigo::ProviderCoi` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Corrigo::ProviderCoi`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'amt_coverage')
        self.amt_coverage = attributes[:'amt_coverage']
      end
    ...
    def hash
      [id, perform_deletion, concurrency_id, display_as, employee_id, amt_coverage, status_id, start_date, end_date, comment, currency_type_id].hash
    end
