...
module Corrigo
  class Responsibility
    ...
    attr_accessor :assignee_type_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Corrigo::Responsibility` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Corrigo::Responsibility`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'assignee_type_id')
        self.assignee_type_id = attributes[:'assignee_type_id']
      end

      if attributes.key?(:'responsibility_type')
        self.responsibility_type = attributes[:'responsibility_type']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          assignee_type_id == o.assignee_type_id &&
          responsibility_type == o.responsibility_type
    end
    ...
    def hash
      [id, perform_deletion, concurrency_id, actor_id, actor_type_id, assignee_id, assignee_type_id, responsibility_type].hash
    end
