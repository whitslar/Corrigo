  ...
  class Specialty
    ...
    def self.openapi_types
      {
        ...
        :'is_removed' => :'Boolean',
        :'display_as' => :'String',
        :'won_service_id' => :'Integer',
        :'instructions' => :'String',
        :'tax_code' => :'TaxCode',
        :'currencies' => :'Array<SpecialtyMoneyValues>',
        :'is_nte_auto' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Corrigo::Specialty` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Corrigo::Specialty`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'won_service_id')
        self.won_service_id = attributes[:'won_service_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          won_service_id == o.won_service_id &&
    ...
    def hash
      [id, perform_deletion, concurrency_id, is_removed, display_as, won_service_id, instructions, tax_code, currencies, is_nte_auto].hash
    end
