  ...
  class WoItem
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Corrigo::WoItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Corrigo::WoItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'sort_order_idx')
        self.sort_order_idx = attributes[:'sort_order_idx']
      end
      ...
      if attributes.key?(:'asset_location')
        self.asset_location = attributes[:'asset_location']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sort_order_idx == o.sort_order_idx &&
          disposition == o.disposition &&
          asset_location == o.asset_location &&
          asset == o.asset &&
          task == o.task &&
          comment == o.comment
    end
    ...
    def hash
      [id, perform_deletion, concurrency_id, work_order_id, sort_order_idx, disposition, asset_location, asset, task, comment].hash
    end
