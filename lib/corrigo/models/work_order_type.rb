...
module Corrigo
  class WorkOrderType
    ...
    attr_accessor :is_def_sr

    attr_accessor :is_def_basic
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Corrigo::WorkOrderType` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Corrigo::WorkOrderType`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_def_sr')
        self.is_def_sr = attributes[:'is_def_sr']
      end

      if attributes.key?(:'is_def_basic')
        self.is_def_basic = attributes[:'is_def_basic']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          type_id == o.type_id &&
          abbr == o.abbr &&
          is_def_sr == o.is_def_sr &&
          is_def_basic == o.is_def_basic
    end
    ...
    def hash
      [id, perform_deletion, concurrency_id, is_removed, display_as, type_id, abbr, is_def_sr, is_def_basic].hash
    end
